    ...
    <ReactMarkdown
      ...
      components={{
        ...
        a: ({ href, children, ...props }) => (
          <a href={href} className="text-primary underline underline-offset-2 hover:no-underline" {...props}>
            {children}
          </a>
        ),
        ...
        code: ({ className, children, ...props }) =>
          className ? (
            <code className="bg-secondary p-2 rounded block my-2 overflow-x-auto text-sm font-mono" {...props}>
              {children}
            </code>
          ) : (
